...
1. 📹 **Everyday Online Video Huddles (`LiveVideoRoom.tsx`)**:
   - **Interactive Camera & Mic**: Direct WebRTC preview via `navigator.mediaDevices.getUserMedia` with fallback simulation.
   - **Screen Share Engine**: Instant screen sharing toggle (`getDisplayMedia`) for code walk-throughs and architecture diagrams.
...
3. 🛡️ **Sanctuary Privacy & Stealth Protocol**:
   - Stealth mode anonymity protects early-stage founder intellectual property.
   - End-to-end encrypted huddle logs with zero-knowledge audit trails.

4. 👥 **Divided Company Roles**:
   - **Founder & CEO**: Vision, capitalization, executive alignment.
   - **Tech Co-Founder & CTO**: Architectural strategy, matching algorithms, platform scaling.
   - **Lead Software Engineer**: Core systems, graph database, pull request velocity.
   - **Head of Product & Psychology**: Chemistry assessment framework, user experience loops.
   - **Head of UI/UX Design**: Visual craft, matcha brand identity, mobile decks.
   - **Growth & Operations Lead**: UK engineering community vetting, Republic campaign.
   - **Engineering Advisor**: Senior technical advisory and roadmap peer review.
...
- **Typography**: `Montserrat`, `JetBrains Mono`, `Courier Prime`
